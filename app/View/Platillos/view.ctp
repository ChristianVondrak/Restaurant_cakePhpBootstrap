...
<div class="row">
	...
	<div class="col col-sm-5">
		...
		<h3 class="h3-h"><strong><?php echo $platillo['Platillo']['nombre']; ?></strong></h3>

		<br />
		<p class="text-p"> Precio: $ <span id="productprice"><?php echo h($platillo['Platillo']['precio']); ?></span></p>

		<?php echo $this->Form->button('Agregar a pedido',array('class'=>'btn btn-primary addtocart', 'id' =>$platillo['Platillo']['id'])); ?>
		<br /><br /><br />
		<p class="text-p"> Descripción: <?php echo ($platillo['Platillo']['descripcion']); ?></p>

		<p class="text-p"> Creado: <?php echo $platillo['Platillo']['created']; ?></p>

		<p class="text-p">Modificado: <?php echo $platillo['Platillo']['modified']; ?></p>

		<p class="text-p">Categoría: <?php echo $this->Html->link($platillo['CategoriaPlatillo']['categoria'], array('controller' => 'categoria_platillos', 'action' => 'view', $platillo['CategoriaPlatillo']['id'])); ?></p>
		<br />
		<br />
		<div class="btn-group">
...
<?php endif; ?>
	...
	<div class="actions">
		<?php echo $this->Html->link(__('New Cocinero'), array('controller' => 'cocineros', 'action' => 'add'), array('class' => 'btn btn-sm btn-success')); ?>
	</div>
</div>
